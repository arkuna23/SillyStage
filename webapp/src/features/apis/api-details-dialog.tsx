...
export function ApiDetailsDialog({
  apiId,
  onOpenChange,
  open,
}: ApiDetailsDialogProps) {
          ...
          {apiConfig ? (
            <>
              <div className="rounded-[1.35rem] border border-[var(--color-border-subtle)] bg-[var(--color-bg-elevated)] px-4 py-4">
                <p className="text-xs text-[var(--color-text-muted)]">{t('apis.apiForm.fields.apiId')}</p>
                <p className="mt-2 font-medium text-[var(--color-text-primary)]">{apiConfig.api_id}</p>
                <p className="mt-4 text-xs text-[var(--color-text-muted)]">{t('apis.apiForm.fields.displayName')}</p>
                <p className="mt-2 text-sm text-[var(--color-text-primary)]">{apiConfig.display_name}</p>
              </div>

              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-[1.35rem] border border-[var(--color-border-subtle)] bg-[var(--color-bg-elevated)] px-4 py-4">
                  <p className="text-xs text-[var(--color-text-muted)]">{t('apis.apiForm.fields.provider')}</p>
                ...
                <div className="rounded-[1.35rem] border border-[var(--color-border-subtle)] bg-[var(--color-bg-elevated)] px-4 py-4">
                  <p className="text-xs text-[var(--color-text-muted)]">{t('apis.apiForm.fields.model')}</p>
                ...
                <div className="rounded-[1.35rem] border border-[var(--color-border-subtle)] bg-[var(--color-bg-elevated)] px-4 py-4 md:col-span-2">
                  <p className="text-xs text-[var(--color-text-muted)]">{t('apis.apiForm.fields.baseUrl')}</p>
                  <p className="mt-2 break-all text-sm text-[var(--color-text-primary)]">{apiConfig.base_url}</p>
                </div>

                <div className="rounded-[1.35rem] border border-[var(--color-border-subtle)] bg-[var(--color-bg-elevated)] px-4 py-4 md:col-span-2">
                  <div className="flex items-center justify-between gap-3">
                    <p className="text-xs text-[var(--color-text-muted)]">{t('apis.apiDetails.keyStatus')}</p>
