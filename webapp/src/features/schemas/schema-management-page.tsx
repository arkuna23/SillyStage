...
export function SchemaManagementPage() {
  ...
  const existingSchemaIds = useMemo(() => schemas.map((schema) => schema.schema_id), [schemas])
  ...
  async function handleCreatePresets(
    presetKinds: ReadonlyArray<(typeof schemaPresets)[number]['kind']>,
  ) {
                  ...
                  {selectionMode ? (
                    ...
                    <>
                      ...
                      <IconButton
                        ...
                        label={
                          isImporting ? t('schemas.actions.importing') : t('schemas.actions.import')
                        }
                        onClick={() => {
