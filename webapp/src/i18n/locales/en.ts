const en = {
    ...
    dataPackage: {
      ...
      dialogs: {
        export: {
          ...
          tabsLabel: 'Export resource groups',
      ...
      filters: {
        ...
        charactersSummary: '{{count}} selected / {{total}} total',
        charactersTitle: 'Candidates',
        folderEmpty: 'No folders match the current filter.',
        folderSearchPlaceholder: 'Search folders',
        folderTitle: 'Folders',
        searchPlaceholder: 'Search by id, name, personality, style, or tags',
        selectionTitle: 'Selection',
        tagsEmpty: 'No tags are available yet.',
        tagsTitle: 'Tags',
        unfiled: 'Unfiled',
      },
      summary: {
  ...
  presetsPage: {
    actions: {
      ...
      deselect: 'Deselect',
      deleting: 'Deleting...',
      dragModule: 'Drag module to reorder',
    ...
    form: {
      ...
      moduleHint:
        'Built-in modules keep their module ID. Built-in entries only allow enabled and order changes, while custom entries can edit title and text.',
    ...
    preview: {
      ...
      actorPurposes: {
        advanceGoal: 'Advance Goal',
        commentOnScene: 'Comment on Scene',
        reactToPlayer: 'React to Player',
      },
      allModules: 'All Modules',
      architectModes: {
        draftContinue: 'Draft Continue',
      ...
      feedback: {
        ...
        copyFailed: 'Failed to copy the prompt.',
        generateFailed: 'Failed to generate the prompt preview.',
        loadCharactersFailed: 'Failed to load session characters for preview.',
      ...
      fields: {
        ...
        character: 'Character',
        draft: 'Draft',
        keeperPhase: 'Keeper Phase',
        module: 'Module',
        narratorPurpose: 'Narrator Purpose',
        playerInput: 'Player Input',
        previewKind: 'Preview Type',
        previousNodeId: 'Previous Node ID',
        replyLimit: 'Reply Limit',
        resource: 'Story Resource',
        session: 'Session',
      },
      keeperPhases: {
        afterPlayerInput: 'After Player Input',
        afterTurnOutputs: 'After Turn Outputs',
      },
      kinds: {
        runtime: 'Runtime',
        template: 'Template',
      ...
      narratorPurposes: {
        describeResult: 'Describe Result',
        describeScene: 'Describe Scene',
        describeTransition: 'Describe Transition',
      },
      placeholders: {
        character: 'Choose a character',
        draft: 'Choose a draft',
        playerInput: 'Optional. Fill player input when the runtime context depends on it.',
        previousNodeId: 'Optional previous node ID',
        replyLimit: '3',
        resource: 'Choose a story resource',
        session: 'Choose a session',
      },
      resultTitle: 'Prompt Viewer',
      title: 'Prompt Preview',
      unresolvedTitle: 'Unresolved Context Keys',
      validation: {
        characterRequired: 'Choose a character before generating the preview.',
        draftRequired: 'Choose a draft before generating the preview.',
        replyLimitInvalid: 'Reply limit must be an integer greater than 0.',
        resourceRequired: 'Choose a story resource before generating the preview.',
        sessionRequired: 'Choose a session before generating the preview.',
      },
      viewer: {
        entry: 'Entry',
        module: 'Module',
        noEntryContent: 'No compiled content for this entry.',
        rawSection: 'Unmatched Section',
        showEntryMarkers: 'Mark entries',
        synthetic: 'Injected',
  ...
  stories: {
    ...
    manualCreate: {
      create: 'Create Story',
      currentSchema: 'current value',
      description:
        'Fill in the story metadata and common variables first, then edit the graph only when you need it in a separate dialog.',
      defaults: {
        goal: 'Describe what this opening node is meant to push forward.',
        scene: 'Describe the opening scene, mood, and baseline situation for this story.',
        title: 'Opening',
      },
      descriptions: {
        basic:
          'Bind the story resource, schemas, and introduction first, then add the common variables you want to keep visible.',
        graph:
          'Then draw the full story graph by hand. Stage will use these nodes and transitions directly afterward.',
      },
      emptySchemas:
        'No schemas are available yet. Prepare the player and world schemas in the Schemas page first, then come back to create a story manually.',
      errors: {
        introductionRequired: 'Introduction is required.',
        loadSchemasFailed: 'Failed to load schemas.',
        playerSchemaRequired: 'Choose a player schema first.',
        submitFailed: 'Failed to create the story.',
        worldSchemaRequired: 'Choose a world schema first.',
      },
      headings: {
        basic: 'Prepare Story Metadata',
    ...
    graph: {
      ...
      charactersPlaceholder: 'Choose existing characters to add',
      charactersSummary: '{{names}} and {{count}} total',
      canvasTitle: 'Graph Canvas',
      characterSelectPlaceholder: 'Choose a character',
      clearSelection: 'Clear selection',
      condition: 'Transition Condition',
      conditionCharacter: 'Character',
      conditionCharacterPlaceholder: 'Choose a character',
      ...
      keySelectPlaceholder: 'Choose a variable key',
      keySourceEmpty: 'This state schema does not expose any fields.',
      keySourceLoadFailed: 'Failed to load variable keys.',
      keySourceLoading: 'Loading variable keys...',
      keySourceMissing: 'No state schema is available for this source.',
      keySourceSelectCharacterFirst: 'Choose a character before choosing a variable key.',
      missingCharacter: 'Character missing',
      nodeId: 'Node ID',
      nodeSection: 'Node',
      nodeTitle: 'Node Title',
      noCharactersAvailable: 'No characters are available.',
      noMatchingCharacters: 'No characters match the current search.',
      onEnterUpdateCharacter: 'Character',
      onEnterUpdateCharacterPlaceholder: 'Choose a character',
      ...
      reset: 'Reset',
      scene: 'Scene',
      searchCharactersPlaceholder: 'Search by name, ID, or tag',
      save: 'Save Graph',
      saving: 'Saving...',
      ...
      emptyCharactersSelection: 'No characters selected yet.',
      start: 'Start',
      ...
      errors: {
        ...
        missingConditionCharacter: 'Character conditions need a character.',
        missingConditionKey: 'Condition key is required.',
        missingOnEnterUpdateCharacter: 'Character state updates need a character.',
